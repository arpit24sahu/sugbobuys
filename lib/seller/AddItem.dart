...
//        emailC.text.length>0&&
        ...
        pic1C.text!="https://i.imgur.com/EPupHzs.png"&&
        pic2C.text!="https://i.imgur.com/EPupHzs.png"&&
        pic3C.text!="https://i.imgur.com/EPupHzs.png"&&
        pic4C.text!="https://i.imgur.com/EPupHzs.png"
    ){
      print("All Data set");
...
//      sellerC.clear();
      ...
      Flushbar(
        title: "Pictures not uploaded properly",
        message: "Please upload the pictures properly.",
        duration: Duration(seconds: 7),
        borderRadius: 10,
        backgroundColor: Colors.deepPurpleAccent,
        dismissDirection: FlushbarDismissDirection.VERTICAL,
...
//                Text("${_uploading.toString()}"),
//                Text(" "),
//                Center(child: Text("Image 1")),
                Text(" "),
                Center(
                  child: Material(
                    elevation: 10,
